...
public class AddControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO dao = new DAO();
        dao.insertProduct(pname, pimage, pprice, ptitle, pdescription, pcategory, sid, pmodel, pcapacity, pdelivery, pimage2, pimage3, pimage4);
        request.setAttribute("mess", "Đã Thêm Sản Phẩm!");
