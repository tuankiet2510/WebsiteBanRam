			...
			<div class="modal-content">
				<form action="add" method="post">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label>Hình Ảnh 1</label> <input name="image" type="text"
								class="form-control">
						</div>
						<div class="form-group">
							<label>Hình Ảnh 2</label> <input name="image2" type="text"
								class="form-control">
						</div>
						<div class="form-group">
							<label>Hình Ảnh 3</label> <input name="image3" type="text"
								class="form-control">
						</div>
						<div class="form-group">
							<label>Hình Ảnh 4</label> <input name="image4" type="text"
								class="form-control">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label>Dung Lượng</label> <input name="capacity" type="text"
								class="form-control">
						</div>
						<div class="form-group">
							<label>Vận Chuyển</label> <input name="delivery" type="text"
								class="form-control">
						</div>
						<div class="form-group">
							<label>Mô Tả</label>
						...
						<div class="form-group">
							<label>Hãng</label> <select name="category"
